    ...
    double& h_inv)
{
  ...
  __declspec(align(16)) float ref_patch_dv[patch_area];
    ...
    Eigen::Vector2d& cur_px_estimate)
{
  ...
  // compute derivative of template and prepare inverse compositional
  __declspec(align(16)) int16_t  ref_patch_dx[patch_area];
  __declspec(align(16)) int16_t  ref_patch_dy[patch_area];
