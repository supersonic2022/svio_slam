...
struct Feature
{
  ...
  Feature(Frame* _frame, const Eigen::Vector2d& _px, const Eigen::Vector3d& _f, int _level) :
    type(CORNER),
    frame(_frame),
    px(_px),
    f(_f),
  ...
  Feature(Frame* _frame, Point* _point, const Eigen::Vector2d& _px, const Eigen::Vector3d& _f, int _level) :
    type(CORNER),
    frame(_frame),
    px(_px),
    f(_f),
